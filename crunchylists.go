...
func (c *Crunchyroll) Crunchylists() (*Crunchylists, error) {
	endpoint := fmt.Sprintf("https://www.crunchyroll.com/content/v1/custom-lists/%s?locale=%s", c.Config.AccountID, c.Locale)
...
func (cl *Crunchylists) Create(name string) (*Crunchylist, error) {
	endpoint := fmt.Sprintf("https://www.crunchyroll.com/content/v1/custom-lists/%s?locale=%s", cl.crunchy.Config.AccountID, cl.crunchy.Locale)
...
func (cl *Crunchylist) AddSeriesFromID(id string) error {
	endpoint := fmt.Sprintf("https://www.crunchyroll.com/content/v1/custom-lists/%s/%s?locale=%s", cl.crunchy.Config.AccountID, cl.ID, cl.crunchy.Locale)
...
func (cl *Crunchylist) RemoveSeriesFromID(id string) error {
	endpoint := fmt.Sprintf("https://www.crunchyroll.com/content/v1/custom-lists/%s/%s/%s?locale=%s", cl.crunchy.Config.AccountID, cl.ID, id, cl.crunchy.Locale)
...
func crunchylistFromID(crunchy *Crunchyroll, id string) (*Crunchylist, error) {
	endpoint := fmt.Sprintf("https://www.crunchyroll.com/content/v1/custom-lists/%s/%s?locale=%s", crunchy.Config.AccountID, id, crunchy.Locale)
...
func (cli *CrunchylistItem) Remove() error {
	endpoint := fmt.Sprintf("https://www.crunchyroll.com/content/v1/custom-lists/%s/%s/%s", cli.crunchy.Config.AccountID, cli.ListID, cli.ID)
