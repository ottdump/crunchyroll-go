...
func (c *Crunchyroll) Account() (*Account, error) {
	resp, err := c.request("https://www.crunchyroll.com/accounts/v1/me", http.MethodGet)
	if err != nil {
		return nil, err
	}
	...
	resp, err = c.request("https://www.crunchyroll.com/accounts/v1/me/profile", http.MethodGet)
	if err != nil {
		return nil, err
	}
	defer resp.Body.Close()
...
func (a *Account) ChangePassword(currentPassword, newPassword string) error {
	endpoint := "https://www.crunchyroll.com/accounts/v1/me/credentials"
...
func (a *Account) AvailableWallpapers() (w []*Wallpaper, err error) {
	endpoint := "https://www.crunchyroll.com/assets/v1/wallpaper"
